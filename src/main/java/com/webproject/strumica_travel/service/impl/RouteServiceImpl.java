...
public class RouteServiceImpl implements RouteService {
    ...
    @Override
    public Optional<Route> save(String name,String description,String duration,List<Long> touristAttractionsIds) {
        ...
        if(name==null || name.isEmpty() || description==null || description.isEmpty()  || duration==null || duration.isEmpty())
        {
            throw new IllegalArgumentException();
        }
        Route route=new Route(name,description,duration,touristAttractions);
        return Optional.of(routeRepository.save(route));
    }

    @Override
    public Optional<Route> edit(Long id, String name,String description,String duration,List<Long> touristAttractionsIds) {
